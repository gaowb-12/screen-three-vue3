<template>
    <g>
        ...
        <path :d="path" :stroke="strokeColor" :stroke-width="strokeWidth" stroke-dasharray="5,5" />
        <path class="path-line" :d="path" :stroke="color" :stroke-width="strokeWidth + 1" :mask="`url(#${maskId})`"
            @click="$emit('clickPath')" @mouseenter="$emit('mouseEnterPath', $event)"  @mouseover="$emit('mouseEnterPath', $event)"
